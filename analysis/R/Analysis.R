...
#           font.label = list(size = 18, family = "serif"),
#           legend.grob = get_legend(prop_chase),
#           legend = "bottom")
...
# (i) clumped and (ii) dispersed sessions
# (b) the number of chases received by each bat of each sex during
# (i) clumped and (ii) dispersed sessions
